    ...
    <div data-aos="fade-left" data-aos-duration="1500">
      <div className="container" style={{ marginTop: "100px" }}>
        <div id='recent_works'>
          ...
          <a href="https://virgool.io" style={{ textAlign: "center", width: "100%", display: "block" }}>
            <button style={{ marginTop: "20px" }} className="btn btn-primary btn-rounded btn-animate">Load More</button>
          </a>
        </div>
      </div>
    </div>
