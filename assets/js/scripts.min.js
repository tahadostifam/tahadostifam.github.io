function initMap() {
	var t = new google.maps.LatLng(48.859003, 2.345275),
		e = { zoom: 16, center: t, mapTypeControl: !1, disableDefaultUI: !0, zoomControl: !0, scrollwheel: !1, styles: [{ stylers: [{ hue: "#ff1a00" }, { invert_lightness: !0 }, { saturation: -100 }, { lightness: 33 }, { gamma: 0.5 }] }, { featureType: "water", elementType: "geometry", stylers: [{ color: "#2D333C" }] }] },
		n = new google.maps.Map(document.getElementById("map"), e);
	new google.maps.Marker({ position: t, map: n, title: "We are here!" });
}
!(function (t, e) {
	"use strict";
		...
		(S.extend = S.fn.extend =
			function () {
				...
				for ("boolean" == typeof s && ((l = s), (s = arguments[a] || {}), a++), "object" == typeof s || S.isFunction(s) || (s = {}), a === u && ((s = this), a--); a < u; a++)
					if (null != (t = arguments[a])) for (e in t) (n = s[e]), s !== (i = t[e]) && (l && i && (S.isPlainObject(i) || (r = Array.isArray(i))) ? ((o = r ? ((r = !1), n && Array.isArray(n) ? n : []) : n && S.isPlainObject(n) ? n : {}), (s[e] = S.extend(l, o, i))) : void 0 !== i && (s[e] = i));
				return s;
			}),
		S.extend({
			...
			map: function (t, e, n) {
				var i,
					...
					o = 0,
					s = [];
				if (b(t)) for (i = t.length; o < i; o++) null != (r = e(t[o], o, n)) && s.push(r);
			...
			proxy: function (t, e) {
				var n, i, r;
				if (("string" == typeof e && ((n = t[e]), (e = t), (t = n)), S.isFunction(t)))
					return (
	...
	var x = (function (n) {
		...
		for (t in ((h = ot.support = {}),
				...
				function (t) {
					...
					return (
						...
						((s = (E = i).documentElement),
							(T = !r(E)),
							y !== E && (n = E.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", it, !1) : n.attachEvent && n.attachEvent("onunload", it)),
							...
							(ut(function (t) {
								(s.appendChild(t).innerHTML = "<a id='" + S + "'></a><select id='" + S + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
									...
									t.querySelectorAll("[selected]").length || g.push("\\[" + z + "*(?:value|" + D + ")"),
							...
							(h.matchesSelector = Q.test((c = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector))) &&
							ut(function (t) {
			...
			(ot.matchesSelector = function (t, e) {
				if (((t.ownerDocument || t) !== E && C(t), (e = e.replace($, "='$1']")), h.matchesSelector && T && !_[e + " "] && (!a || !a.test(e)) && (!g || !g.test(e))))
					try {
						var n = c.call(t, e);
						...
						return 1 === m && 0 === g
							...
							: function (t, e, n) {
								...
								if (c) {
									if (v) {
										for (; l;) {
											for (s = t; (s = s[l]);) if (b ? s.nodeName.toLowerCase() === f : 1 === s.nodeType) return !1;
									...
									} else if ((d && (h = a = (i = (r = (o = (s = t)[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === k && i[1]), !1 === h)) for (; (s = (++a && s && s[l]) || (h = a = 0) || u.pop()) && ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++h || (d && ((r = (o = s[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [k, h]), s !== t)););
			...
			return t.first
				...
				: function (t, e, n) {
					var i,
						...
						s = [k, d];
					if (n) {
						for (; (t = t[u]);) if ((1 === t.nodeType || f) && a(t, e, n)) return !0;
					} else
						for (; (t = t[u]);)
							if (1 === t.nodeType || f)
			...
			return (
				...
				at(function (t, e, n, i) {
					var r,
						...
						d = m ? (v || (t ? h : l || g) ? [] : e) : f;
					if ((m && m(f, d, n, i), g)) for (r = xt(d, u), g(r, [], n, i), o = r.length; o--;) (s = r[o]) && (d[u[o]] = !(f[u[o]] = s));
					if (t) {
						if (v || h) {
							if (v) {
			...
			for (
				...
				if ((e = x.relative[t[a].type])) c = [yt(bt(c), e)];
					...
					if ((e = x.filter[t[a].type].apply(null, t[a].matches))[S]) {
						...
						return wt(1 < a && bt(c), 1 < a && vt(t.slice(0, a - 1).concat({ value: " " === t[a - 2].type ? "*" : "" })).replace(H, "$1"), e, a < n && Ct(t.slice(a, n)), n < i && Ct((t = t.slice(n))), n < i && vt(t));
					}
					c.push(e);
				}
			return bt(c);
			...
			(p = ot.tokenize =
				function (t, e) {
					...
					for (s = t, a = [], u = x.preFilter; s;) {
						for (o in ((n && !(i = B.exec(s))) || (i && (s = s.slice(i[0].length) || s), a.push((r = []))), (n = !1), (i = W.exec(s)) && ((n = i.shift()), r.push({ value: n, type: i[0].replace(H, " ") }), (s = s.slice(n.length))), x.filter)) !(i = U[o].exec(s)) || (u[o] && !(i = u[o](i))) || ((n = i.shift()), r.push({ value: n, type: o, matches: i }), (s = s.slice(n.length)));
						if (!n) break;
					}
	...
	((S.fn.init = function (t, e, n) {
		...
		if (i[1]) {
			if (((e = e instanceof S ? e[0] : e), S.merge(this, S.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : T, !0)), O.test(i[1]) && S.isPlainObject(e))) for (i in e) S.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
			return this;
		}
	...
	(S.Callbacks = function (i) {
		...
		var r,
			...
			l = -1,
			c = function () {
				for (s = s || i.once, o = r = !0; u.length; l = -1) for (e = u.shift(); ++l < a.length;) !1 === a[l].apply(e[0], e[1]) && i.stopOnFalse && ((l = a.length), (e = !1));
	...
	(S.fn.ready = function (t) {
		...
		(S.ready.then = H.then),
		"complete" === T.readyState || ("loading" !== T.readyState && !T.documentElement.doScroll) ? E.setTimeout(S.ready) : (T.addEventListener("DOMContentLoaded", B), E.addEventListener("load", B));
	var W = function (t, e, n, i, r, o, s) {
		var a = 0,
			u = t.length,
			l = null == n;
		if ("object" === S.type(n)) for (a in ((r = !0), n)) W(t, e, a, n[a], !0, o, s);
		else if (
			void 0 !== i &&
			((r = !0),
				S.isFunction(i) || (s = !0),
	...
	(Y.uid = 1),
		(Y.prototype = {
			cache: function (t) {
				...
				return e || ((e = {}), $(t) && (t.nodeType ? (t[this.expando] = e) : Object.defineProperty(t, this.expando, { value: e, configurable: !0 }))), e;
			},
			set: function (t, e, n) {
				var i,
					r = this.cache(t);
	...
	function nt(t, e, n, i) {
		...
		if (c && c[3] !== l) for (l = l || c[3], n = n || [], c = +u || 1; (c /= o = o || ".5"), S.style(t, e, c + l), o !== (o = a() / u) && 1 !== o && --s;);
	...
	function rt(t, e) {
		for (var n, i, r = [], o = 0, s = t.length; o < s; o++)
			(i = t[o]).style &&
				((n = i.style.display),
					e
						? ("none" === n && ((r[o] = X.get(i, "display") || null), r[o] || (i.style.display = "")), "" === i.style.display && tt(i) && (r[o] = ((f = l = u = void 0), (l = (a = i).ownerDocument), (c = a.nodeName), (f = it[c]) || ((u = l.body.appendChild(l.createElement(c))), (f = S.css(u, "display")), u.parentNode.removeChild(u), "none" === f && (f = "block"), (it[c] = f)))))
	...
	function pt(t, e, n, i, r) {
		...
		for (f.textContent = "", h = 0; (o = d[h++]);)
			...
			else if (((l = S.contains(o.ownerDocument, o)), (s = lt(f.appendChild(o), "script")), l && ct(s), n)) for (c = 0; (o = s[c++]);) at.test(o.type || "") && n.push(o);
		return f;
	}
	...
	(S.event = {
				...
				for (
					...
					(h = m = (a = yt.exec(t[l]) || [])[1]),
						...
						((f = S.event.special[h] || {}),
							...
							(f = S.event.special[h] || {}),
							(c = S.extend({ type: h, origType: m, data: i, handler: n, guid: n.guid, selector: r, needsContext: r && S.expr.match.needsContext.test(r), namespace: p.join(".") }, o)),
							(d = u[h]) || (((d = u[h] = []).delegateCount = 0), (f.setup && !1 !== f.setup.call(e, i, p, s)) || (e.addEventListener && e.addEventListener(h, s))),
			...
			if (g && (u = g.events)) {
				for (l = (e = (e || "").match(z) || [""]).length; l--;)
					if (((h = m = (a = yt.exec(e[l]) || [])[1]), (p = (a[2] || "").split(".").sort()), h)) {
						for (f = S.event.special[h] || {}, d = u[(h = (i ? f.delegateType : f.bindType) || h)] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;)
		...
		dispatch: function (t) {
			...
			if (((a.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, a))) {
				for (s = S.event.handlers.call(this, a, l), e = 0; (r = s[e++]) && !a.isPropagationStopped();)
					for (a.currentTarget = r.elem, n = 0; (o = r.handlers[n++]) && !a.isImmediatePropagationStopped();) (a.rnamespace && !a.rnamespace.test(o.namespace)) || ((a.handleObj = o), (a.data = o.data), void 0 !== (i = ((S.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, u)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
		...
		(S.Event = function (t, e) {
			return this instanceof S.Event
				? (t && t.type ? ((this.originalEvent = t), (this.type = t.type), (this.isDefaultPrevented = t.defaultPrevented || (void 0 === t.defaultPrevented && !1 === t.returnValue) ? bt : xt), (this.target = t.target && 3 === t.target.nodeType ? t.target.parentNode : t.target), (this.currentTarget = t.currentTarget), (this.relatedTarget = t.relatedTarget)) : (this.type = t),
					e && S.extend(this, e),
		...
		S.each({ mouseenter: "mouseover", mouseleave: "mouseout", pointerenter: "pointerover", pointerleave: "pointerout" }, function (t, r) {
			S.event.special[t] = {
				delegateType: r,
				bindType: r,
				handle: function (t) {
	...
	function jt(t, e) {
		var n, i, r, o, s, a, u, l;
		if (1 === e.nodeType) {
			if (X.hasData(t) && ((o = X.access(t)), (s = X.set(e, o)), (l = o.events))) for (r in (delete s.handle, (s.events = {}), l)) for (n = 0, i = l[r].length; n < i; n++) S.event.add(e, r, l[r][n]);
	...
	function It(n, i, r, o) {
		...
		if (f && ((e = (t = pt(i, n[0].ownerDocument, !1, n, o)).firstChild), 1 === t.childNodes.length && (t = e), e || o)) {
			...
			if (a) for (l = s[s.length - 1].ownerDocument, S.map(s, Lt), c = 0; c < a; c++) (u = s[c]), at.test(u.type || "") && !X.access(u, "globalEval") && S.contains(l, u) && (u.src ? S._evalUrl && S._evalUrl(u.src) : v(u.textContent.replace(_t, ""), l));
		}
		return n;
	}
	function Nt(t, e, n) {
	...
	S.extend({
		...
		clone: function (t, e, n) {
			...
			if (!(g.noCloneChecked || (1 !== t.nodeType && 11 !== t.nodeType) || S.isXMLDoc(t))) for (s = lt(c), i = 0, r = (o = lt(t)).length; i < r; i++) (a = o[i]), (u = s[i]), void 0, "input" === (l = u.nodeName.toLowerCase()) && ot.test(a.type) ? (u.checked = a.checked) : ("input" !== l && "textarea" !== l) || (u.defaultValue = a.defaultValue);
			if (e)
				if (n) for (o = o || lt(t), s = s || lt(c), i = 0, r = o.length; i < r; i++) jt(o[i], s[i]);
				else jt(t, c);
	...
	function Yt(t) {
		...
		return (
			...
			(e = S.cssProps[t] =
				(function (t) {
					if (t in $t) return t;
					for (var e = t[0].toUpperCase() + t.slice(1), n = Wt.length; n--;) if ((t = Wt[n] + e) in $t) return t;
				})(t) || t),
			e
		);
	}
	...
	S.extend({
				...
				return (
					...
					void 0 === n
						? s && "get" in s && void 0 !== (r = s.get(t, !1, i))
							? r
							: l[e]
						: ("string" === (o = typeof n) && (r = K.exec(n)) && r[1] && ((n = nt(t, e, r)), (o = "number")), void (null != n && n == n && ("number" === o && (n += (r && r[3]) || (S.cssNumber[a] ? "" : "px")), g.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), (s && "set" in s && void 0 === (n = s.set(t, n, i))) || (u ? l.setProperty(e, n) : (l[e] = n)))))
				);
			}
		},
		...
		S.each(["height", "width"], function (t, s) {
			S.cssHooks[s] = {
				get: function (t, e, n) {
					if (e)
						return !Ft.test(S.css(t, "display")) || (t.getClientRects().length && t.getBoundingClientRect().width)
							? Vt(t, s, n)
							: et(t, Ht, function () {
								return Vt(t, s, n);
							});
	...
	function oe(t, e, n) {
		for (var i, r = (se.tweeners[e] || []).concat(se.tweeners["*"]), o = 0, s = r.length; o < s; o++) if ((i = r[o].call(n, e, t))) return i;
	}
	function se(o, t, e) {
		var n,
			s,
		...
		for (
			(function (t, e) {
				var n, i, r, o, s;
				for (n in t)
					if (((r = e[(i = S.camelCase(n))]), (o = t[n]), Array.isArray(o) && ((r = o[1]), (o = t[n] = o[0])), n !== i && ((t[i] = o), delete t[n]), (s = S.cssHooks[i]) && ("expand" in s))) for (n in ((o = s.expand(o)), delete t[i], o)) (n in t) || ((t[n] = o[n]), (e[n] = r));
					else e[i] = r;
		...
		return S.map(c, oe, l), S.isFunction(l.opts.start) && l.opts.start.call(o, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), S.fx.timer(S.extend(u, { elem: o, anim: l, queue: l.opts.queue })), l;
	}
	(S.Animation = S.extend(se, {
				...
				if ((u = !S.isEmptyObject(e)) || !S.isEmptyObject(h))
					for (i in (f &&
						...
						((n.overflow = [p.overflow, p.overflowX, p.overflowY]),
							...
							"none" === (c = S.css(t, "display")) && (l ? (c = l) : (rt([t], !0), (l = t.style.display || l), (c = S.css(t, "display")), rt([t]))),
						...
						h))
						u ||
							(g ? "hidden" in g && (m = g.hidden) : (g = X.access(t, "fxshow", { display: l })),
								o && (g.hidden = !m),
								m && rt([t], !0),
								d.done(function () {
		...
		(S.speed = function (t, e, n) {
			var i = t && "object" == typeof t ? S.extend({}, t) : { complete: n || (!n && e) || (S.isFunction(t) && t), duration: t, easing: (n && e) || (e && !S.isFunction(e) && e) };
			return (
		...
		S.each({ slideDown: re("show"), slideUp: re("hide"), slideToggle: re("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (t, i) {
			...
			attr: function (t, e, n) {
				...
				if (3 !== o && 8 !== o && 2 !== o)
					return void 0 === t.getAttribute
						? S.prop(t, e, n)
						: ((1 === o && S.isXMLDoc(t)) || (r = S.attrHooks[e.toLowerCase()] || (S.expr.match.bool.test(e) ? ae : void 0)), void 0 !== n ? (null === n ? void S.removeAttr(t, e) : r && "set" in r && void 0 !== (i = r.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n)) : r && "get" in r && null !== (i = r.get(t, e)) ? i : null == (i = S.find.attr(t, e)) ? void 0 : i);
			},
			attrHooks: {
				type: {
					set: function (t, e) {
		...
		S.fn.extend({
			...
			toggleClass: function (r, e) {
				...
				return "boolean" == typeof e && "string" === o
					...
					: S.isFunction(r)
						...
						: this.each(function () {
							var t, e, n, i;
							if ("string" === o) for (e = 0, n = S(this), i = r.match(z) || []; (t = i[e++]);) n.hasClass(t) ? n.removeClass(t) : n.addClass(t);
			...
			hasClass: function (t) {
				var e,
					n,
					i = 0;
				for (e = " " + t + " "; (n = this[i++]);) if (1 === n.nodeType && -1 < (" " + fe(de(n)) + " ").indexOf(e)) return !0;
				return !1;
			},
		});
	var he = /\r/g;
	S.fn.extend({
		val: function (n) {
			...
			return arguments.length
				...
				: e
					? (i = S.valHooks[e.type] || S.valHooks[e.nodeName.toLowerCase()]) && "get" in i && void 0 !== (t = i.get(e, "value"))
						? t
			...
			if (
				((o = s = n = n || T),
					...
					(-1 < d.indexOf(".") && ((d = (h = d.split(".")).shift()), h.sort()),
						(u = d.indexOf(":") < 0 && "on" + d),
						((t = t[S.expando] ? t : new S.Event(d, "object" == typeof t && t)).isTrigger = i ? 2 : 3),
						(t.namespace = h.join(".")),
				...
				for (r = 0; (o = f[r++]) && !t.isPropagationStopped();) (t.type = 1 < r ? a : c.bindType || d), (l = (X.get(o, "events") || {})[t.type] && X.get(o, "handle")) && l.apply(o, e), (l = u && o[u]) && l.apply && $(o) && ((t.result = l.apply(o, e)), !1 === t.result && t.preventDefault());
	...
	function Ne(o) {
		return function (t, e) {
			...
			if (S.isFunction(e)) for (; (n = r[i++]);) "+" === n[0] ? ((n = n.slice(1) || "*"), (o[n] = o[n] || []).unshift(e)) : (o[n] = o[n] || []).push(e);
		};
	}
	function Me(e, r, o, s) {
		var a = {},
	...
	(Ie.href = me.href),
		S.extend({
			...
			ajax: function (t, e) {
				...
				var c,
					...
					C = {
						...
						getResponseHeader: function (t) {
							var e;
							if (p) {
								if (!n) for (n = {}; (e = ke.exec(d));) n[e[1].toLowerCase()] = e[2];
								e = n[t.toLowerCase()];
							}
				...
				for (r in ((m = S.event && g.global) && 0 == S.active++ && S.event.trigger("ajaxStart"),
					...
					(f = g.url.replace(Te, "")),
					g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Ee, "+")) : ((o = g.url.slice(f.length)), g.data && ((f += (ve.test(f) ? "&" : "?") + g.data), delete g.data), !1 === g.cache && ((f = f.replace(Se, "$1")), (o = (ve.test(f) ? "&" : "?") + "_=" + ge++ + o)), (g.url = f + o)),
					g.ifModified && (S.lastModified[f] && C.setRequestHeader("If-Modified-Since", S.lastModified[f]), S.etag[f] && C.setRequestHeader("If-None-Match", S.etag[f])),
					((g.data && g.hasContent && !1 !== g.contentType) || e.contentType) && C.setRequestHeader("Content-Type", g.contentType),
					C.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + je + "; q=0.01" : "") : g.accepts["*"]),
					g.headers))
				...
				function l(t, e, n, i) {
					...
					p ||
						((p = !0),
							...
							r ? (g.ifModified && ((u = C.getResponseHeader("Last-Modified")) && (S.lastModified[f] = u), (u = C.getResponseHeader("etag")) && (S.etag[f] = u)), 204 === t || "HEAD" === g.type ? (l = "nocontent") : 304 === t ? (l = "notmodified") : ((l = a.state), (o = a.data), (r = !(s = a.error)))) : ((s = l), (!t && l) || ((l = "error"), t < 0 && (t = 0))),
							(C.status = t),
							(C.statusText = (e || l) + ""),
							...
							x.fireWith(v, [C, l]),
							m && (y.trigger("ajaxComplete", [C, g]), --S.active || S.event.trigger("ajaxStop")));
				}
				return C;
			},
		...
		S.each(["get", "post"], function (t, r) {
			S[r] = function (t, e, n, i) {
				return S.isFunction(e) && ((i = i || n), (n = e), (e = void 0)), S.ajax(S.extend({ url: t, type: r, dataType: i, data: e, success: n }, S.isPlainObject(t) && t));
			};
		}),
							...
							return function () {
								o &&
									((o = s = i.onload = i.onerror = i.onabort = i.onreadystatechange = null),
										"abort" === t ? i.abort() : "error" === t ? ("number" != typeof i.status ? e(0, "error") : e(i.status, i.statusText)) : e(ze[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? { binary: i.response } : { text: i.responseText }, i.getAllResponseHeaders()));
							};
						}),
							(i.onload = o()),
							(s = i.onerror = o("error")),
	...
	S.ajaxSetup({
		...
		S.ajaxPrefilter("json jsonp", function (t, e, n) {
			var i,
				r,
				o,
				s = !1 !== t.jsonp && (Re.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Re.test(t.data) && "data");
			if (s || "jsonp" === t.dataTypes[0])
				return (
					(i = t.jsonpCallback = S.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
					s ? (t[s] = t[s].replace(Re, "$1" + i)) : !1 !== t.jsonp && (t.url += (ve.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
		...
		(g.createHTMLDocument = (((qe = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === qe.childNodes.length)),
		...
		(S.fn.load = function (t, e, n) {
			...
			return (
				...
				S.isFunction(e) ? ((n = e), (e = void 0)) : e && "object" == typeof e && (r = "POST"),
				0 < s.length &&
		...
		(S.offset = {
			setOffset: function (t, e, n) {
				...
				"static" === l && (t.style.position = "relative"),
					...
					(o = S.css(t, "top")),
					(u = S.css(t, "left")),
					(r = ("absolute" === l || "fixed" === l) && -1 < (o + u).indexOf("auto") ? ((s = (i = c.position()).top), i.left) : ((s = parseFloat(o) || 0), parseFloat(u) || 0)),
		...
		S.fn.extend({
			offset: function (e) {
				...
				var t,
					...
					r,
					o = this[0];
				return o ? (o.getClientRects().length ? ((i = o.getBoundingClientRect()), (n = (t = o.ownerDocument).documentElement), (r = t.defaultView), { top: i.top + r.pageYOffset - n.clientTop, left: i.left + r.pageXOffset - n.clientLeft }) : { top: 0, left: 0 }) : void 0;
			},
			position: function () {
				if (this[0]) {
					var t,
						...
						n = this[0],
						i = { top: 0, left: 0 };
					return "fixed" === S.css(n, "position") ? (e = n.getBoundingClientRect()) : ((t = this.offsetParent()), (e = this.offset()), _(t[0], "html") || (i = t.offset()), (i = { top: i.top + S.css(t[0], "borderTopWidth", !0), left: i.left + S.css(t[0], "borderLeftWidth", !0) })), { top: e.top - i.top - S.css(n, "marginTop", !0), left: e.left - i.left - S.css(n, "marginLeft", !0) };
				}
			},
		...
		c.extend(c.fn, {
			...
			rules: function (t, e) {
				...
				if (null != u && (!u.form && u.hasAttribute("contenteditable") && ((u.form = this.closest("form")[0]), (u.name = this.attr("name"))), null != u.form)) {
					if (t)
						switch (((i = (n = c.data(u.form, "validator").settings).rules), (r = c.validator.staticRules(u)), t)) {
							case "add":
					...
					return (o = c.validator.normalizeRules(c.extend({}, c.validator.classRules(u), c.validator.attributeRules(u), c.validator.dataRules(u), c.validator.staticRules(u)), u)).required && ((s = o.required), delete o.required, (o = c.extend({ required: s }, o))), o.remote && ((s = o.remote), delete o.remote, (o = c.extend(o, { remote: s }))), o;
				}
			},
		}),
			...
			c.extend(c.validator, {
				...
				prototype: {
						...
						return "radio" === r || "checkbox" === r
							...
							: "number" === r && void 0 !== t.validity
								? t.validity.badInput
									? "NaN"
									: i.val()
								: ((e = t.hasAttribute("contenteditable") ? i.text() : i.val()), "file" === r ? ("C:\\fakepath\\" === e.substr(0, 12) ? e.substr(12) : 0 <= (n = e.lastIndexOf("/")) ? e.substr(n + 1) : 0 <= (n = e.lastIndexOf("\\")) ? e.substr(n + 1) : e) : "string" == typeof e ? e.replace(/\r/g, "") : e);
					},
					check: function (e) {
					...
					stopRequest: function (t, e) {
						this.pendingRequest--,
							...
							e && 0 === this.pendingRequest && this.formSubmitted && this.form() ? (c(this.currentForm).submit(), this.submitButton && c("input:hidden[name='" + this.submitButton.name + "']", this.currentForm).remove(), (this.formSubmitted = !1)) : !e && 0 === this.pendingRequest && this.formSubmitted && (c(this.currentForm).triggerHandler("invalid-form", [this]), (this.formSubmitted = !1));
					},
				...
				normalizeRules: function (i, r) {
					return (
						...
						c.validator.autoCreateRanges && (null != i.min && null != i.max && ((i.range = [i.min, i.max]), delete i.min, delete i.max), null != i.minlength && null != i.maxlength && ((i.rangelength = [i.minlength, i.maxlength]), delete i.minlength, delete i.maxlength)),
						i
					);
				},
											...
											!0,
											{
												...
												success: function (t) {
													...
													(u.settings.messages[s.name][a] = l.originalMessage),
														r ? ((i = u.formSubmitted), u.resetInternals(), (u.toHide = u.errorsFor(s)), (u.formSubmitted = i), u.successList.push(s), (u.invalid[s.name] = !1), u.showErrors()) : ((e = {}), (n = t || u.defaultMessage(s, { method: a, parameters: o })), (e[s.name] = l.message = n), (u.invalid[s.name] = !0), u.showErrors(e)),
														(l.valid = r),
														u.stopRequest(s, r);
												},
											},
	...
	(function (t) {
		...
		(t.prototype = {
			...
			open: function (t) {
				...
				if (!f.isOpen) {
					(f.types = []),
						...
						f.st.preloader && (f.preloader = x("preloader", f.container, f.st.tLoading));
					...
					w("BeforeOpen"),
						...
						f.fixedContentPos ? f.wrap.css({ overflow: f.st.overflowY, overflowX: "hidden", overflowY: f.st.overflowY }) : f.wrap.css({ top: y.scrollTop(), position: "absolute" }),
						(!1 === f.st.fixedBgPos || ("auto" === f.st.fixedBgPos && !f.fixedContentPos)) && f.bgOverlay.css({ height: d.height(), position: "absolute" }),
			...
			parseEl: function (t) {
				var e,
					n = f.items[t];
				if ((n = n.tagName ? { el: c(n) } : ((e = n.type), { data: n, src: n.src })).el) {
			...
			(c.fn.magnificPopup = function (t) {
				...
				if ("string" == typeof t)
					if ("open" === t) {
						...
						(n = i.items ? i.items[r] : ((n = e), i.delegate && (n = n.find(i.delegate)), n.eq(r))), f._openClick({ mfpEl: n }, e, i);
			...
			proto: {
				...
				getImage: function (t, e) {
					...
					return (
						...
						f.resizeImage(),
						t.hasSize ? (I && clearInterval(I), t.loadError ? (e.addClass("mfp-loading"), f.updateStatus("error", o.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), f.updateStatus("ready"))) : (f.updateStatus("loading"), (t.loading = !0), t.hasSize || ((t.imgHidden = !0), e.addClass("mfp-loading"), f.findImageSize(t))),
						e
					);
				},
			},
		...
		c.magnificPopup.registerModule("zoom", {
			...
			proto: {
				...
				_getOffset: function (t) {
					var e,
						n = (e = t ? f.currItem.img : f.st.zoom.opener(f.currItem.el || f.currItem)).offset(),
						i = parseInt(e.css("padding-top"), 10),
						r = parseInt(e.css("padding-bottom"), 10);
					n.top -= c(window).scrollTop() - i;
					var o = { width: e.width(), height: (a ? e.innerHeight() : e[0].offsetHeight) - r - i };
	...
	(function (e, n) {
		"use strict";
		"function" == typeof define && define.amd
			? define("fizzy-ui-utils/utils", ["matches-selector/matches-selector"], function (t) {
				return n(e, t);
			})
			: "object" == typeof module && module.exports
	...
	(function (n, i) {
		"function" == typeof define && define.amd
			? define("outlayer/item", ["ev-emitter/ev-emitter", "get-size/get-size"], function (t, e) {
				return i(n, t, e);
			})
			: "object" == typeof module && module.exports
			...
			(l._transitionTo = function (t, e) {
				...
				if ((this.setPosition(t, e), !s || this.isTransitioning)) {
					var a = t - n,
						u = e - i,
						l = {};
					(l.transform = this.getTranslate(a, u)), this.transition({ to: l, onTransitionEnd: { transform: this.layoutPosition }, isCleaning: !0 });
		...
		(l.enableTransition = function () {
			this.isTransitioning || (this.css({ transitionProperty: c, transitionDuration: this.layout.options.transitionDuration }), this.element.addEventListener(s, this, !1));
		}),
	...
	(function (r, o) {
		...
		(c.namespace = "outlayer"), (c.Item = i), (c.defaults = { containerStyle: { position: "relative" }, initLayout: !0, originLeft: !0, originTop: !0, resize: !0, resizeContainer: !0, transitionDuration: "0.4s", hiddenStyle: { opacity: 0, transform: "scale(0.001)" }, visibleStyle: { opacity: 1, transform: "scale(1)" } });
		var f = c.prototype;
		function d(t) {
			function e() {
	...
	(function (t, e) {
		...
		return (
			...
			(e.prototype._getItemLayoutPosition = function (t) {
				...
				for (var i = this._getColGroup(n), r = Math.min.apply(Math, i), o = i.indexOf(r), s = { x: this.columnWidth * o, y: r }, a = r + t.size.outerHeight, u = this.cols + 1 - i.length, l = 0; l < u; l++) this.colYs[o + l] = a;
				return s;
			}),
		...
		return (function (n) {
					...
					return (
						...
						(n = [
							...
							},
							{
								key: "defaultOptions",
								get: function () {
									return { autoHide: !0, forceVisible: !1, classNames: { content: "simplebar-content", scrollContent: "simplebar-scroll-content", scrollbar: "simplebar-scrollbar", track: "simplebar-track" }, scrollbarMinSize: 25 };
								},
							},
							{
								key: "htmlAttributes",
								get: function () {
									return { autoHide: "data-simplebar-auto-hide", forceVisible: "data-simplebar-force-visible", scrollbarMinSize: "data-simplebar-scrollbar-min-size" };
								},
							},
						]),
						(e = [
							...
							},
							{
								...
								value: function () {
									...
									if (
										...
										(this.trackX = this.el.querySelector(".".concat(this.classNames.track, ".horizontal"))), (this.trackY = this.el.querySelector(".".concat(this.classNames.track, ".vertical"))), (this.scrollContentEl = this.el.querySelector(".".concat(this.classNames.scrollContent))), (this.contentEl = this.el.querySelector(".".concat(this.classNames.content)));
									else {
							...
							},
							{
								...
								value: function () {
									var t,
										...
										i,
										r,
										o = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "y",
									...
									(this.isVisible[o] = r < i),
										this.isVisible[o] || this.options.forceVisible
											? ((t.style.visibility = "visible"), this.options.forceVisible ? (e.style.visibility = "hidden") : (e.style.visibility = "visible"), "x" === o ? ((e.style.left = "".concat(l, "px")), (e.style.width = "".concat(u, "px"))) : ((e.style.top = "".concat(l, "px")), (e.style.height = "".concat(u, "px"))))
			...
			function (t, e, n) {
				...
				t.exports = function (t, e, n, i, r, o, s) {
					...
					if (
						(y && (l = _(y.call(new t()))) !== Object.prototype && l.next && (k(l, f, !0), b || E(l, O) || C(l, O, L)),
							d &&
							m &&
							"values" !== m.name &&
							((h = !0),
						...
						if (((a = { values: d ? g : c("values"), keys: o ? g : c("keys"), entries: v }), s)) for (u in a) u in p || w(p, u, a[u]);
					...
					"Array",
					{
						from: function (t) {
							var e,
								...
								c = 0,
								f = y(o);
							if ((l && (u = d(u, 2 < a ? arguments[2] : void 0, 2)), null == f || (s == Array && m(f)))) for (n = new s((e = g(o.length))); c < e; c++) v(n, c, l ? u(o[c], c) : o[c]);
							else for (r = f.call(o), n = new s(); !(i = r.next()).done; c++) v(n, c, l ? p(r, u, [i.value, c], !0) : i.value);
							return (n.length = c), n;
						},
					}
				);
			...
			function (r, t, e) {
				(function (t) {
					...
					r.exports = function (i, r, t) {
						...
						return (
							(r = b(r) || 0),
							y(t) && ((g = !!t.leading), (f = (v = "maxWait" in t) ? x(b(t.maxWait) || 0, r) : f), (n = "trailing" in t ? !!t.trailing : n)),
							(e.cancel = function () {
			...
			function (t, e, n) {
					...
					(p.prototype.connect_ = function () {
						s &&
							...
							(document.addEventListener("transitionend", this.onTransitionEnd_),
								...
								c ? ((this.mutationsObserver_ = new MutationObserver(this.refresh)), this.mutationsObserver_.observe(document, { attributes: !0, childList: !0, characterData: !0, subtree: !0 })) : (document.addEventListener("DOMSubtreeModified", this.refresh), (this.mutationEventsAdded_ = !0)),
								(this.connected_ = !0));
					}),
				...
				var b = function (t, e) {
					var n,
						...
						a,
						u,
						l = ((i = (n = e).x), (r = n.y), (o = n.width), (s = n.height), (a = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object), (u = Object.create(a.prototype)), m(u, { x: i, y: r, width: o, height: s, top: r, right: i + o, bottom: s + r, left: i }), u);
		...
		(o.prototype = {
				...
				if (!0 !== this.stop) {
					...
					i.timeout = setTimeout(function () {
						if ("html" === i.contentType && ">" === e.substr(n).charAt(0)) {
							for (; "<" !== e.substr(n).charAt(0);) e.substr(n).charAt(0), n--;
							n--, "<";
						}
						var t = e.substr(0, n);
			...
			shuffleArray: function (t) {
				var e,
					n,
					i = t.length;
				if (i) for (; --i;) (e = t[(n = Math.floor(Math.random() * (i + 1)))]), (t[n] = t[i]), (t[i] = e);
				return t;
			},
			reset: function () {
	...
	$(function () {
		...
		var t = $(window).width(),
			e = $(window).height();
		if (
			($(".typed-title").typed({ stringsElement: $(".typing-title"), backDelay: 5e3, typeSpeed: 0, loop: !0 }),
		...
		n.imagesLoaded(function () {
			n.multipleFilterMasonry({ itemSelector: ".grid-item", filtersGroupSelector: ".filter-button-group", percentPosition: !0, gutter: 0 });
		}),
			$(".filter-button-group").on("change", 'input[type="radio"]', function () {
				$(this).is(":checked") && ($(".f_btn").removeClass("active"), $(this).closest(".f_btn").addClass("active")),
					$(".has-popup-image").magnificPopup({ type: "image", closeOnContentClick: !0, mainClass: "popup-box", image: { verticalFit: !0 } }),
					$(".has-popup-video").magnificPopup({ disableOn: 700, type: "iframe", removalDelay: 160, preloader: !1, fixedContentPos: !1, mainClass: "popup-box" }),
					$(".has-popup-music").magnificPopup({ disableOn: 700, type: "iframe", removalDelay: 160, preloader: !1, fixedContentPos: !1, mainClass: "popup-box" }),
					$(".has-popup-media").magnificPopup({ type: "inline", overflowY: "auto", closeBtnInside: !0, mainClass: "popup-box-inline" });
			}),
			$(".has-popup-image").magnificPopup({ type: "image", closeOnContentClick: !0, mainClass: "popup-box", image: { verticalFit: !0 } }),
			$(".has-popup-video").magnificPopup({ disableOn: 700, type: "iframe", removalDelay: 160, preloader: !1, fixedContentPos: !1, mainClass: "popup-box" }),
			$(".has-popup-music").magnificPopup({ disableOn: 700, type: "iframe", removalDelay: 160, preloader: !1, fixedContentPos: !1, mainClass: "popup-box" }),
			...
			$("#comment_form").validate({ rules: { name: { required: !0 }, message: { required: !0 } }, success: "valid", submitHandler: function () { } }),
			$("#map").length && initMap(),
			$(".blogs-content").height() > $(".blogs-sidebar").height() && 1023 < t && $(".blogs-sidebar").css({ "min-height": $(".blogs-content").height() }),
			$(".blogs-content").height() < $(".blogs-sidebar").height() && 1023 < t && $(".blogs-content").css({ "min-height": $(".blogs-sidebar").height() }),
			$(window).resize(function () {
				var t = $(window).width();
				$(".blogs-content").height() > $(".blogs-sidebar").height() && 1023 < t && $(".blogs-sidebar").css({ "min-height": $(".blogs-content").height() }), $(".blogs-content").height() < $(".blogs-sidebar").height() && 1023 < t && $(".blogs-content").css({ "min-height": $(".blogs-sidebar").height() });
			}),
			$(".top-menu").on("click", "a", function () {
